...
const Navbar = () => {
    ...
    return (
        <div className="nav-container">
            ...
            {activeMenu && (
                <Menu theme="dark" defaultSelectedKeys={navHighlight}>
                    <Menu.Item icon={<HomeOutlined />} key="1">
                        <Link to="/" onClick={() => {setNavHighlight("1")}}>Home</Link>
                    </Menu.Item>
                    <Menu.Item icon={<FundOutlined />} key="2">
                        <Link to="/cryptocurrencies" onClick={() => {setNavHighlight("2")}}>Cryptocurrencies</Link>
                    </Menu.Item>
